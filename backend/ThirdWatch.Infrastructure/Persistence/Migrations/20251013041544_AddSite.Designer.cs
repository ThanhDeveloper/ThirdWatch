...
namespace ThirdWatch.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251013041544_AddSite")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThirdWatch.Domain.Entities.Site", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("CurrentResponseTimeMs")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PreferredIntervalMinutes")
                        .HasColumnType("int");

                    b.PrimitiveCollection<string>("ResponseTrendData")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<int>("SslExpiresInDays")
                        .HasColumnType("int");

                    b.Property<decimal>("StabilityPercentage")
                    ...
                    b.ToTable("Sites", t =>
                        {
                            t.HasCheckConstraint("CK_Sites_HealthStatus_Enum", "[HealthStatus] IN (N'Healthy', N'Warning', N'Critical')");

                            t.HasCheckConstraint("CK_Sites_LastStatus_Enum", "[LastStatus] IN (N'Up', N'Down', N'Error')");
                        });
                });
