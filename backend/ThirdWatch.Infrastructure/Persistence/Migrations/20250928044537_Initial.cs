        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HttpMethod = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_WebhookEndpoints_HttpMethod_Enum", "[HttpMethod] IN (N'Post', N'Get')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "WebhookHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PayloadBlobUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebhookHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WebhookHistories_WebhookEndpoints_WebhookEndpointId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebhookHistories_WebhookEndpointId",
